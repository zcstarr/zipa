...
def main():
    ...
    test_cuts = [test_clean_dl, test_other_dl, test_doreco_dl, test_ucla_dl, test_aishell_dl, test_mls_french_dl, test_mls_german_dl, test_mls_italian_dl, test_mls_portuguese_dl, test_mls_spanish_dl, test_mls_dutch_dl,test_buckeye_dl,test_l2_arctic_dl,test_l2_arctic_preceived_dl]
